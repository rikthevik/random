...
inputstr = """asgwdcmbrkerohqoutfylvzpnx
...
diffs = []
for l1, l2 in itertools.combinations(inputstr.splitlines(), 2):
    diffs.append(diff(l1, l2))

print(sorted(diffs, key=len, reverse=True)[0])
