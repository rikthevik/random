...
defmodule Problem do
  ...
  def part1(inputs) do
    ...
    overlaps = MapSet.new(wire1) |> MapSet.intersection(MapSet.new(wire2))
    "PART1 OUT: " |> IO.write
    overlaps 
  ...
  def part2(inputs) do
    ...
    wire2 = inputs |> Enum.at(1) |> Problem.moves_to_wire
    wire2_delays = Map.new(Enum.zip(wire1, 1..Enum.count(wire1)))
...
defmodule Tests do 
  ...
  test "sample input 1" do
    input = "R8,U5,L5,D3\nU7,R6,D4,L4"
    |> Problem.load
    assert input |> Problem.part1 == 6
    assert input |> Problem.part2 == 30
  end

  test "sample input 2" do
    input = "R75,D30,R83,U83,L12,D49,R71,U7,L72\nU62,R66,U55,R34,D71,R55,D58,R83"
    |> Problem.load 
    assert input |> Problem.part1 == 159
    assert input |> Problem.part2 == 610
  end

  test "sample input 3" do
    input = "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
    |> Problem.load 
    assert input |> Problem.part1 == 135
    assert input |> Problem.part2 == 410
  end
